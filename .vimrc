...
map <F2> i# include <string.h><cr># include <stdlib.h><cr># include <unistd.h><cr># include <signal.h><cr># include <fcntl.h><cr># include <stdio.h><cr># include <limits.h><cr><Esc>
